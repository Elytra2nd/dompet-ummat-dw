          ...
          <Popup>
            <div className="font-sans">
              ...
              <div className="text-xs text-slate-600 mt-1">
                <p><strong>Desa:</strong> {item.dim_lokasi.desa_kelurahan}</p>
                <p><strong>Kec:</strong> {item.dim_lokasi.kecamatan}</p>
              </div>
              <div className="mt-2 pt-2 border-t text-[10px] text-slate-400">
                Lat: {item.dim_lokasi.latitude.toFixed(5)}, Lng: {item.dim_lokasi.longitude.toFixed(5)}
              </div>
            </div>
          </Popup>
        </Marker>
