...
import { 
  ...
  ClipboardList, RefreshCw, Eye, MoreHorizontal 
} from 'lucide-react'
                      ...
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <Link href={`/mustahik/${item.id_mustahik}`}>
                          <Button 
                            variant="ghost" 
                            size="icon" 
                            className="h-9 w-9 text-slate-400 hover:text-emerald-600 hover:bg-emerald-50 border border-transparent hover:border-emerald-200 transition-all"
                            title="Lihat Profil & Histori SCD"
                          >
