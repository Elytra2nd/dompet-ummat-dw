...
export default function ReportsPage() {
  ...
  // 2. CUSTOM PDF FORMAT (Fix: Menggunakan Direct Call autoTable)
  const exportCustomPDF = (data: any[], title: string) => {
    try {
      ...
      // Gunakan fungsi autoTable yang diimport langsung
      autoTable(doc, {
        startY: 55,
      ...
      // Tanda Tangan (Mengakses finalY dari hasil autoTable)
    ...
    <div className="flex items-center justify-center min-h-screen bg-white">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="font-black text-slate-400 uppercase tracking-widest text-sm text-center">
          Mempersiapkan Laporan Warehouse...
        </p>
      </div>
    </div>
  )
